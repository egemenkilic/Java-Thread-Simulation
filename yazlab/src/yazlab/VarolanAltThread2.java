...
import static yazlab.arayuz.jProgressBar1;

public class VarolanAltThread2 extends Thread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                jProgressBar1.setMaximum(sub_kapasite);//barı kapasiteye göre ayarladım
                jProgressBar1.setValue(isteksub);//barda gözükecek olan sayı
